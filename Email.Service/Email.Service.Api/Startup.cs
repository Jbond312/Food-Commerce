...
using System.Linq;
using AutoMapper;
using Email.Service.Api.SwaggerHelpers;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(x =>
            {
                ...
                x.SwaggerDoc("v1.0", new Info
                {
                    Title = "Email Service",
                    Version = "v1.0",
                    Description = "API responsible for email related queries and commands"
                });
            ...
            app.UseSwaggerUI(x =>
                {
                    ...
                    x.SwaggerEndpoint("/swagger/v1.0/swagger.json", "Email Service v1.0");
                }
            );
            app.UseMvc();
        }
